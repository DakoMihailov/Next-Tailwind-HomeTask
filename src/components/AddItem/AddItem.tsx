...
import { add } from '@/stores/infoSlice'
...
const AddItem: NextPage<Prop> = ({ onSetItem, setToastStatus }) => {
  ...
  return (
    <div className=' mt-12 border rounded-lg px-6 pt-4 pb-8 w-sm  bg-white shadow '>
      <div className='flex justify-center'>
        <div className='font-bold not-italic text-info w-full'>New Location</div>
        <div
